...
namespace task_schedule {
	...
	namespace internal {
		...
		class BindStateBase
			: public utils::RefCountedThreadSafe<BindStateBase, BindStateBaseRefCountTraits> {
		public:
		...
		private:
			...
			friend class utils::RefCountedThreadSafe<BindStateBase, BindStateBaseRefCountTraits>;
			...
			friend struct ::task_schedule::FakeBindState;
