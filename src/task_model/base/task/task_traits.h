...
class BASE_EXPORT TaskTraits {
 public:
  ...
  template<class ValidTrait, class... ArgTypes>
  inline constexpr bool AllValidTrait() {
	  for (auto a : std::initializer_list<bool>({ trait_helpers::IsValidTrait<ValidTrait, ArgTypes>()... }))
	  {
		  if (!a)
		  {
			  return false;
  ...
  constexpr TaskTraits(ArgTypes... args)
	  : extension_(trait_helpers::GetTaskTraitsExtensionEx(
		  /*trait_helpers::AreValidTraits<ValidTrait, ArgTypes...>{}*/AllValidTrait<ValidTrait, ArgTypes...>(),
		  args...)),
        priority_(
