...
class BASE_EXPORT Value {
 public:
  ...
  explicit Value(base::span<const Value> in_list);
 ...
 protected:
  ...
  const DictStorage& dict() const { return std::get<DictStorage>(data_); }
  DictStorage& dict() { return std::get<DictStorage>(data_); }
  const ListStorage& list() const { return std::get<ListStorage>(data_); }
  ListStorage& list() { return std::get<ListStorage>(data_); }
