...
namespace utils {
	...
	scoped_refptr<T> AdoptRef(T* obj) {
		...
		static_assert(std::is_same<internal::StartRefCountFromOneTag, Tag>::value,
	...
	scoped_refptr<T> MakeRefCounted(Args&&... args) {
		...
		return internal::AdoptRefIfNeeded(obj, T::kRefCountPreference);
	}
	...
	public:
		...
		~scoped_refptr() {
			static_assert(!internal::IsRefCountPreferenceOverridden(
	...
	private:
		...
		scoped_refptr(T* p, internal::AdoptRefTag) : ptr_(p) {}
